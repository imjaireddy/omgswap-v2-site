...
module.exports = {
  siteMetadata: {
    title: `OMGSwap`,
    description: `Southeast Asian First DeFi Protocol Project Automated LP based on Ethereum`,
    author: `@omegadefi`,
    menulinks: menu,
    siteUrl: `https://omgswap.com`,
    repository: `https://github.com/omgswap/omg-site`,
