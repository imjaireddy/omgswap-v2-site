  ...
  return (
    <Layout path={props.location.pathname}>
      ...
      <SEO
        ...
        description={'Omega Protocol is decentralized finance (Open finance) refers to the crypto (digital) assets and ethereum smart contracts, protocols, and decentralized application (dApp) built on ethereum'}
      />
      <StyledBody>
        <StyledTitle>
          ...
          ethereum smart contracts, protocols, and decentralized application (dApp) built on ethereum.</StyledBodyTitle3>
          <span>
            <Button href="https://omgswap.com/">OMGSwap App</Button>
            <Button href="/">Omega DEX</Button>
...
const SummarySection = props => {
  return (
    <StyledSectionFlex>
      ...
      <StyledImgSection>
        <h1>
          <b>OMGSwap</b> is a fully decentralized protocol for automated LP based on Ethereum.
        </h1>
          ...
          <ColS>
            <Card>
              <h1>
                ...
                <p>
                  Use OMGSwap pool with all supported ERC20 tokens to get constant passive income. Can create new pool for liquidity exposure by own control.
                </p>
            </Card>
          </ColS>
          <ColS>
